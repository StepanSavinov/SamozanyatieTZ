...
{
    public class RGDialogsClients : IRGDialogsClientsService
    {
        ...
        public Guid GetDialog(List<Guid> clientsIds)
        {
            var clientsDialogs = Init()
            ...
            foreach (var clientsDialog in clientsDialogs
                         .Where(clientsDialog => clientsIds
                             .OrderBy(x => x)
                             .SequenceEqual(clientsDialog.Value
                                 .OrderBy(x => x))))
            {
                return clientsDialog.Key;
            }
            return Guid.Empty;
        }
